...
ChatGPT and Claude 3.5 Sonnet are very effective at developing ExcalidrawAutomate scripts. To achieve the best result I recommend attaching 3 files for these LLMs to use as reference.
